...
/// 推送二维码数据
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull write_QRCode;)
+ (NSNotificationName _Nonnull)write_QRCode SWIFT_WARN_UNUSED_RESULT;
/// 获取是否有二维码
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull otherFunction;)
+ (NSNotificationName _Nonnull)otherFunction SWIFT_WARN_UNUSED_RESULT;
/// 杰里蓝牙设置监听
/// 手机已关闭蓝牙
