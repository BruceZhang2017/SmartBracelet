...
- (void)startDialPush:(NSData * _Nonnull)data MTU:(NSInteger)MTU;
- (void)setDialPush:(NSData * _Nonnull)data dataIndex:(NSInteger)dataIndex MUT:(NSInteger)MUT;
/// MARK: 开始壁纸推送
- (void)startImagePush:(NSData * _Nonnull)data MTU:(NSInteger)MTU;
/// MARK: 开始壁纸推送数据
- (void)setImagePush:(NSData * _Nonnull)data dataIndex:(NSInteger)dataIndex MTU:(NSInteger)MTU;
/// MARK: 获取壁纸设置参数
