...
SWIFT_CLASS("_TtC15TJDWristbandSDK13TJDSleepModel")
@interface TJDSleepModel : DataModel
/// 0…6共 7天
/// 0…6 total 7 days
...
/// returns:
/// [SleepTimeModel]
+ (NSArray<SleepTimeModel *> * _Nonnull)sleepTime:(NSArray<TJDSleepModel *> * _Nonnull)array SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15TJDWristbandSDK14SleepTimeModel")
@interface SleepTimeModel : TJDSleepModel
...
- (void)getTemperatureSettingForWristband;
- (void)setTemperatureSettingForWristband:(TemperatureSettingModel * _Nonnull)model;
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull temperatureSettings;)
+ (NSNotificationName _Nonnull)temperatureSettings SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull temperatureMeasure;)
+ (NSNotificationName _Nonnull)temperatureMeasure SWIFT_WARN_UNUSED_RESULT;
