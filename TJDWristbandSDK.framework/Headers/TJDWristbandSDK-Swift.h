...
#ifndef TJDWRISTBANDSDK_SWIFT_H
#define TJDWRISTBANDSDK_SWIFT_H
...
@property (nonatomic) BOOL isKakaoTalk;
@property (nonatomic) BOOL isFacebookMessage;
@property (nonatomic) BOOL isInstagram;
@property (nonatomic) BOOL isWhatappBusiness;
...
@property (nonatomic) NSInteger indexOfTotal;
/// 血压高值
/// High blood pressure
...
SWIFT_CLASS("_TtC15TJDWristbandSDK9DialModel")
@interface DialModel : NSObject
@property (nonatomic, strong) NSMutableArray * _Nonnull jlArray;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class NSData;

SWIFT_CLASS("_TtC15TJDWristbandSDK15DialSelectModel")
@interface DialSelectModel : NSObject
@property (nonatomic) NSInteger selectedIndex;
@property (nonatomic, copy) NSData * _Nonnull imageData;
@property (nonatomic, copy) NSData * _Nonnull binData;
/// 时间上方0 时间下方1
@property (nonatomic) NSInteger timeDirection;
/// 关闭0 日期1 睡眠2 心率3 计步4
@property (nonatomic) NSInteger onTheTime;
/// 关闭0 日期1 睡眠2 心率3 计步4
@property (nonatomic) NSInteger belowTheTime;
...
SWIFT_CLASS("_TtC15TJDWristbandSDK21FunctionCategoryModel")
@interface FunctionCategoryModel : NSObject
/// 是否有二维码
@property (nonatomic) BOOL hasQRCode;
/// 是否有音乐
@property (nonatomic) BOOL hasNewmusic;
/// 是否双备份OTA
@property (nonatomic) BOOL hasDouble;
/// 是否来电挂断提醒（默认不支持）
@property (nonatomic) BOOL hasClosePhone;
/// 作废
@property (nonatomic) BOOL hasEmpty;
/// 杰理平台TJD表盘推送逻辑
@property (nonatomic) BOOL hasJLPush;
/// 更改设备蓝牙名称
@property (nonatomic) BOOL hasEditBlueName;
/// 杰理平台TJD壁纸推送逻辑
@property (nonatomic) BOOL hasJLImagePush;
/// 第二个字节
/// //是否支持新的通讯录协议
@property (nonatomic) BOOL hasAddressBook;
/// 是否支持新的7天天气协议
@property (nonatomic) BOOL hasNewWeather;
/// 禁用蓝牙3.0配对 true禁用  false不禁用
@property (nonatomic) BOOL hasblue3;
/// 隐藏来电提醒app显示 true隐藏 false展示
@property (nonatomic) BOOL hasCallReminder;
/// 心率监测支持
@property (nonatomic) BOOL hasMonitorHeart;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@property (nonatomic) BOOL hasBright;
/// 设备是否有表盘
@property (nonatomic) BOOL hasDial;
/// 设备是否有血氧功能
@property (nonatomic) BOOL hasOxygen;
/// 设备是否有天气功能
@property (nonatomic) BOOL hasWeather;
/// 新加的3个ancs开关识别
@property (nonatomic) BOOL hasANCSSwitch1;
/// 壁纸推送识别
@property (nonatomic) BOOL hasImage;
/// p70 app图片识别
@property (nonatomic) BOOL hasP70;
/// 通讯录识别
@property (nonatomic) BOOL hasAddressBook;
/// f43v app壁纸图片识别
@property (nonatomic) BOOL hasF43vImage;
/// 手环启动相机标识
@property (nonatomic) BOOL hasNewCamera;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (NSString * _Nonnull)wuClassName SWIFT_WARN_UNUSED_RESULT;
- (NSString * _Nonnull)wuClassName SWIFT_WARN_UNUSED_RESULT;
@end
...
@interface NSObject (SWIFT_EXTENSION(TJDWristbandSDK))
/// 获取所有属性的类型
/// Get the type of all properties
///
/// returns:
/// [String]数组
+ (NSArray<NSString *> * _Nonnull)getPropertiesType SWIFT_WARN_UNUSED_RESULT;
/// 获取所有属性的类型
///
/// returns:
/// [String]数组
...
/// returns:
/// [String]数组
+ (NSArray<NSString *> * _Nonnull)getPropertiesName SWIFT_WARN_UNUSED_RESULT;
/// 获取所有属性的名字
///
/// returns:
/// [String]数组
...
/// returns:
/// [Any]数组
- (NSArray * _Nonnull)getPropertiesValue SWIFT_WARN_UNUSED_RESULT;
- (id _Nonnull)getPropertiesValueDic SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC15TJDWristbandSDK15NfcAddressModel")
@interface NfcAddressModel : DataModel
@property (nonatomic) NSInteger delegateVersion;
@property (nonatomic) NSInteger totalCount;
@property (nonatomic) NSInteger indexOfTotal;
@property (nonatomic) NSInteger dataLength;
@property (nonatomic) NSInteger uidLength;
@property (nonatomic, copy) NSString * _Nonnull uid;
@property (nonatomic) NSInteger addressLength;
@property (nonatomic, copy) NSString * _Nonnull address;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15TJDWristbandSDK11OxygenModel")
...
SWIFT_CLASS("_TtC15TJDWristbandSDK16TemperatureModel")
@interface TemperatureModel : DataModel
/// 0…6共 7天
/// 0…6 total 7 days
@property (nonatomic) NSInteger day;
/// 数据总条数
...
@property (nonatomic) NSInteger indexOfTotal;
/// 额头温度
@property (nonatomic) double forehead;
/// 手腕温度
@property (nonatomic) double wrist;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC15TJDWristbandSDK23TemperatureSettingModel")
@interface TemperatureSettingModel : NSObject
...
/// 测试动作类型
typedef SWIFT_ENUM(uint8_t, TestActionType, open) {
  TestActionTypeNoRepeat = 0x00,
  TestActionTypeRepeats = 0x01,
  TestActionTypeEnd = 0x02,
};
...
/// 2的 0，1，2，3，4，5，6，分别代表，周日，周一，周二….周六 累计的和表示有哪几天, 0表示星期天
...
/// 扩展功能
@property (nonatomic, strong) FunctionCategoryModel * _Nonnull funcCategoryModel;
/// 当前发送的ota包序号
/// The currently sent ota package serial number
@property (nonatomic) NSUInteger otaPackIndex;
@property (nonatomic, strong) WUCentralManager * _Nonnull manager;
...
@property (nonatomic, copy) void (^ _Nullable didSetFunction)(BOOL);
@property (nonatomic, copy) void (^ _Nullable didSetTemperatureSettings)(BOOL);
@property (nonatomic, copy) void (^ _Nullable didSetTemperatureStartMeasure)(BOOL);
/// 建立蓝牙管理   ！**************** 只调用一次 ************   ！
...
@interface WUBleManager (SWIFT_EXTENSION(TJDWristbandSDK))
- (void)setMotorShake:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setGSensor:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setScreenBrightness:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setScreenColor:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setKeyTest:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setTpTest:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setHornTest:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setMicrophone:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setElectricityTest:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setRestoreFactorySettings:(enum TestActionType)type isRespond:(BOOL)isRespond;
- (void)setTurnoffBluetooth:(enum TestActionType)type isRespond:(BOOL)isRespond;
@end

@class NSDate;
enum WristbandMeasureType : uint8_t;
@class monitorHeartModel;
@class UIImage;

@interface WUBleManager (SWIFT_EXTENSION(TJDWristbandSDK))
/// temper当前温度 type 0晴天 1多云 2下雨 3下雪 4阴天 max最高温 min最低温
- (void)setWeatherWithTemper:(NSInteger)temper type:(NSInteger)type max:(NSInteger)max min:(NSInteger)min;
- (void)setWeatherForThirdDaysWithTemper:(NSArray<NSNumber *> * _Nonnull)temper type:(NSInteger)type max:(NSArray<NSNumber *> * _Nonnull)max min:(NSArray<NSNumber *> * _Nonnull)min;
- (void)setWeatherForSevenDaysWithTemper:(NSInteger)temper type:(uint8_t)type max:(NSInteger)max min:(NSInteger)min day:(NSInteger)day pressure:(NSInteger)pressure altitude:(NSInteger)altitude;
/// 给手环设置时间
/// Set the time for the bracelet
- (void)setTimeForWristband:(NSDate * _Nonnull)date;
/// 手环绑定手机系统
- (void)bindSetForWristband;
/// 获取手环电量
...
/// \param language Default Locale.preferredLanguages.first!
///
- (void)setLanguageForWristband:(NSString * _Nonnull)language;
...
/// 获取当前计步 Get current step
- (void)getStep;
/// 获取历史计步 Get history step
...
- (void)aloneGetNFC;
/// 开始写入NFC数据
- (void)startWriteNFCWith:(NSData * _Nonnull)data uid:(NSString * _Nullable)uid;
- (void)writeNFC:(NSData * _Nonnull)data dataIndex:(NSInteger)dataIndex;
...
- (void)startDialPush:(NSData * _Nonnull)data;
- (void)setDialPush:(NSData * _Nonnull)data dataIndex:(NSInteger)dataIndex;
/// MARK: 开始壁纸推送
- (void)startImagePush:(NSData * _Nonnull)data;
/// MARK: 开始壁纸推送数据
- (void)setImagePush:(NSData * _Nonnull)data dataIndex:(NSInteger)dataIndex;
/// MARK: 获取壁纸设置参数
- (void)getImagePushSettings;
/// MARK: 设置壁纸设置参数
- (void)setImagePushSettings:(DialSelectModel * _Nonnull)model;
- (void)startAddressPush:(NSData * _Nonnull)data;
- (void)setAddressBook:(NSData * _Nonnull)data dataIndex:(NSInteger)dataIndex;
- (void)getHistoryTemperatureWith:(NSInteger)day;
/// 温度校准
- (void)calibrationTemperature:(NSInteger)mode temper:(NSInteger)temper;
/// 表盘设置信息
- (void)ruiYuDialSet;
/// 发送二维码数据
...
/// 裁剪图片
- (UIImage * _Nullable)tjdScaleWithImage:(UIImage * _Nonnull)image toSize:(CGSize)toSize SWIFT_WARN_UNUSED_RESULT;
/// 新天气类型返回指令
- (uint8_t)getWeaterTypeWithType:(NSInteger)type SWIFT_WARN_UNUSED_RESULT;
/// 新天气类型返回指令 for test
- (uint8_t)getWeaterTypeTestWithType:(NSInteger)type SWIFT_WARN_UNUSED_RESULT;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull readRSSI;)
+ (NSNotificationName _Nonnull)readRSSI SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15TJDWristbandSDK17WUCalendarManager")
@interface WUCalendarManager : NSObject
+ (NSCalendar * _Nonnull)current SWIFT_WARN_UNUSED_RESULT;
+ (NSCalendar * _Nonnull)gregorian SWIFT_WARN_UNUSED_RESULT;
/// \param numOfDay 距离今天的天数
///
/// \param date 今天
///
///
/// returns:
/// 返回偏移后的日期
+ (NSDate * _Nonnull)addWithNumOfDay:(NSInteger)numOfDay date:(NSDate * _Nonnull)date SWIFT_WARN_UNUSED_RESULT;
/// \param numOfWeek 距离今天的周数
///
/// \param date 今天
///
///
/// returns:
/// 返回偏移后的日期
+ (NSDate * _Nonnull)addWithNumOfWeek:(NSInteger)numOfWeek date:(NSDate * _Nonnull)date SWIFT_WARN_UNUSED_RESULT;
/// \param numOfMonth 距离今天的月数
///
/// \param date 今天
///
///
/// returns:
/// 返回偏移后的日期
+ (NSDate * _Nonnull)addWithNumOfMonth:(NSInteger)numOfMonth date:(NSDate * _Nonnull)date SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC15TJDWristbandSDK16WUCentralManager")
...
@interface WUCentralManager (SWIFT_EXTENSION(TJDWristbandSDK))
...
+ (WUDate * _Nonnull)setupWithGregorian:(NSDate * _Nonnull)date SWIFT_WARN_UNUSED_RESULT;
...
- (NSDate * _Nonnull)gregorianDate SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
typedef SWIFT_ENUM(uint8_t, WristbandMeasureType, open) {
  ...
  WristbandMeasureTypeOxygen = 0x04,
};
...
/// 认证绑定设置
/// Authentication binding settings
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull bindSet;)
+ (NSNotificationName _Nonnull)bindSet SWIFT_WARN_UNUSED_RESULT;
...
/// 设备发送血氧测量结果
/// The device sends oxygen measurement results
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull devSendCeLiang_oxygen;)
+ (NSNotificationName _Nonnull)devSendCeLiang_oxygen SWIFT_WARN_UNUSED_RESULT;
/// 历史心率同步
...
/// 历史血压同步
/// Historical blood pressure synchronization
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull sysCeLiang_oxygen;)
+ (NSNotificationName _Nonnull)sysCeLiang_oxygen SWIFT_WARN_UNUSED_RESULT;
/// 读取当天运动数据
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull startDialPush;)
+ (NSNotificationName _Nonnull)startDialPush SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull dialPush;)
+ (NSNotificationName _Nonnull)dialPush SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull setWeather;)
+ (NSNotificationName _Nonnull)setWeather SWIFT_WARN_UNUSED_RESULT;
/// 启动壁纸推送
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull startImagePush;)
+ (NSNotificationName _Nonnull)startImagePush SWIFT_WARN_UNUSED_RESULT;
/// 壁纸推送
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull imagePush;)
+ (NSNotificationName _Nonnull)imagePush SWIFT_WARN_UNUSED_RESULT;
/// 壁纸推送设置
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull imagePushSetting;)
+ (NSNotificationName _Nonnull)imagePushSetting SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull startAddressPush;)
+ (NSNotificationName _Nonnull)startAddressPush SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull addressPush;)
+ (NSNotificationName _Nonnull)addressPush SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull temperature;)
+ (NSNotificationName _Nonnull)temperature SWIFT_WARN_UNUSED_RESULT;
/// 温度
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull temperatureCalibration;)
+ (NSNotificationName _Nonnull)temperatureCalibration SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull read_Temperature;)
+ (NSNotificationName _Nonnull)read_Temperature SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull ruiyu_DialSet;)
+ (NSNotificationName _Nonnull)ruiyu_DialSet SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull nfc_history;)
+ (NSNotificationName _Nonnull)nfc_history SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull nfc_current;)
+ (NSNotificationName _Nonnull)nfc_current SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull write_NFC;)
+ (NSNotificationName _Nonnull)write_NFC SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull write_NFC_complete;)
+ (NSNotificationName _Nonnull)write_NFC_complete SWIFT_WARN_UNUSED_RESULT;
/// 杰里蓝牙设置监听
/// 手机已关闭蓝牙
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull JL_BlueClose;)
+ (NSNotificationName _Nonnull)JL_BlueClose SWIFT_WARN_UNUSED_RESULT;
/// 发现蓝牙
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull JL_didDisconnectPeripheral;)
+ (NSNotificationName _Nonnull)JL_didDisconnectPeripheral SWIFT_WARN_UNUSED_RESULT;
/// 连接
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull JL_didConnect;)
+ (NSNotificationName _Nonnull)JL_didConnect SWIFT_WARN_UNUSED_RESULT;
/// 蓝牙特征
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull JL_didDiscoverChar;)
+ (NSNotificationName _Nonnull)JL_didDiscoverChar SWIFT_WARN_UNUSED_RESULT;
/// 收到通知
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull JL_didUpdateNoti;)
+ (NSNotificationName _Nonnull)JL_didUpdateNoti SWIFT_WARN_UNUSED_RESULT;
/// 手机已关闭蓝牙
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull JL_didUpdateValueFor;)
+ (NSNotificationName _Nonnull)JL_didUpdateValueFor SWIFT_WARN_UNUSED_RESULT;
/// 推送二维码数据
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull sendQRcodeData;)
+ (NSNotificationName _Nonnull)sendQRcodeData SWIFT_WARN_UNUSED_RESULT;
/// 获取扩展新功能
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull readFuncCategory;)
+ (NSNotificationName _Nonnull)readFuncCategory SWIFT_WARN_UNUSED_RESULT;
/// 心率监测通知
...
@interface WristbandNotifyKeys (SWIFT_EXTENSION(TJDWristbandSDK))
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull motorShake;)
+ (NSNotificationName _Nonnull)motorShake SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull gSensor;)
+ (NSNotificationName _Nonnull)gSensor SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull screenBrightness;)
+ (NSNotificationName _Nonnull)screenBrightness SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull screenColor;)
+ (NSNotificationName _Nonnull)screenColor SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull keyTest;)
+ (NSNotificationName _Nonnull)keyTest SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull tpTest;)
+ (NSNotificationName _Nonnull)tpTest SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull hornTest;)
+ (NSNotificationName _Nonnull)hornTest SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull microphone;)
+ (NSNotificationName _Nonnull)microphone SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull electricityTest;)
+ (NSNotificationName _Nonnull)electricityTest SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull restoreFactorySettings;)
+ (NSNotificationName _Nonnull)restoreFactorySettings SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly) NSNotificationName _Nonnull turnoffBluetooth;)
+ (NSNotificationName _Nonnull)turnoffBluetooth SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC15TJDWristbandSDK17monitorHeartModel")
@interface monitorHeartModel : NSObject
/// 是否开启心率监测
@property (nonatomic) BOOL isOn;
/// 开始时间 时
@property (nonatomic) NSInteger startHour;
