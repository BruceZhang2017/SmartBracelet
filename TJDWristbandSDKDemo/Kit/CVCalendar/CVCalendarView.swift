...
public typealias CCAnimator = CVCalendarViewAnimator
public typealias Delegate = CVCalendarViewDelegate
public typealias AppearanceDelegate = CVCalendarViewAppearanceDelegate
public typealias CCAnimatorDelegate = CVCalendarViewAnimatorDelegate
...
public final class CVCalendarView: UIView {
    ...
    public var animator: CCAnimator!
    ...
    public weak var delegate: CVCalendarViewDelegate? {
        didSet {
            ...
            if animator == nil {
                animator = CCAnimator(calendarView: self)
            }
    ...
    @IBOutlet public weak var animatorDelegate: AnyObject? {
        set {
            if let animatorDelegate = newValue as? CCAnimatorDelegate {
