...
public struct DeviceLanguageResponse {
    public let languageType: Int
}

public struct DeviceUnitFormatResponse {
    public let unitFormat: Int
}

public struct SwitchStatusResponse {
...
public struct AlarmData {
    public var alarmIndex: Int
    public var mswitch: Int
    public var alarmCycle: Int
    public var alarmHour: Int
    public var alarmMinute: Int
    public var vibrationMode: Int
    public var remindLater: Int
...
public struct ContactInfoResponse {
    public let contactNum: Int
...
public struct TargetSettingsResponse {
    public let targetSwitch: Int
    public let stepTargetValue: Int
    public let distanceTargetValue: Int
    public let calorieTargetValue: Int
    public let sleepTargetValue: Int
    public let exerciseDurationTargetValue: Int
}

public struct MultiSportModeData {
    public let sportType: Int
    public let timestamp: UInt32
    public let stepCount: UInt32
    public let calorie: UInt32
    public let distance: UInt32
    public let duration: UInt32
    public let avgHeartRate: Int
    public let staticCalorie: UInt32
}

public struct SleepDataResponse {
    public let shallowSleepHour: Int
    public let deepSleepHour: Int
    public let wakeUpNumber: Int
}

public struct AutoSleepMonitoringResponse {
    public let startHour: Int
    public let startMinute: Int
    public let endHour: Int
    public let endMinute: Int
    public let alarmCycle: Int
...
public class XGZTCommand {
    ...
    /// 健康数据存储实现（由外部注入）
    public static var healthDataStorage: HealthDataStorageProtocol = EmptyHealthDataStorage()

    public static let methods: [String] = ["syncTime", "getBatteryLevel"]
    
    // 同步时间
    public static func syncTime(timeZone: Int, utc: UInt32) {
    ...
    // 获取电池电量
    public static func getBatteryLevel() {
        let command = createCommand(with: [
            0x00,
    ...
    public static func getDeviceUnitFormat() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置设备单位格式
    public static func setDeviceUnitFormat(unitType: Int) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.setDeviceUnitFormat.rawValue,
            0x01,
    ...
    // 重置设备为出厂设置
    public static func resetToFactorySettings() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置设备亮屏时间
    public static func setDeviceScreenTimeout(screenTimeout: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 查找手环
    public static func findBand(p0: Int){
        let command = createCommand(with: [
            0x00,
    ...
    public static func disconnectBT() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置天气单位
    public static func setWeatherUnit(unit: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 12小时/24小时时间制
    public static func get12H24HTimeFormat() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置12小时/24小时时间制
    public static func set12H24HTimeFormat(format: Int) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.set12H24HTimeFormat.rawValue,
            0x01,
    ...
    // 设置应用端信息
    public static func setAppInfo(phoneType: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 获取个人信息
    public static func getPersonalInfo() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置个人信息
    public static func setPersonalInfo(sex: Int, age: Int, height: Int, weight: Int) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.personalInfo.rawValue,
            0x01,
    ...
    // 获取开关状态
    public static func getSwitchStatus() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置开关状态
    public static func setSwitchStatus(p0: UInt8, p1: UInt8) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.switchStatus.rawValue,
            0x01,
    ...
    // 绑定设备
    public static func bindDevice(value: UInt8) {
        let command = createCommand(with: [
            0x00,
    ...
    // 获取闹钟信息
    public static func getAlarmInfo(type: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置闹钟信息
    public static func setAlarmInfo(setCmd: Int, alarm: AlarmData) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.alarmInfo.rawValue,
            0x01,
    ...
    // 获取提醒信息
    public static func getReminderInfo(eventType: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置提醒信息
    public static func setReminderInfo(response: ReminderInfoResponse) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.reminderInfo.rawValue,
            0x01,
    ...
    // 获取开关表扩展
    public static func getSwitchTableExtension() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置开关表扩展
    public static func setSwitchTableExtension(p0: UInt8, p1: UInt8, p2: UInt8, p3: UInt8) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.switchTableExtension.rawValue,
            0x01,
    ...
    public static func musicControl(action: Int, dataType: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 远程拍照
    public static func remotePhoto(action: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func messagePush(action: Int, control: Int, messageType: Int, messageContent: Data) {
    ...
    public static func setWeatherInfo(dateType: Int, weatherType: Int, currTemp: Int, lTemp: Int, hTemp: Int, cmd: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 获取联系人信息
    public static func getContactInfo() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置联系人信息
    public static func setContactInfo(index: Int, name: String, phoneNumber: String) {
        // 限制name不超过30个字节
    ...
    // 来电静音
    public static func incomingCallMute(mute: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    // 获取目标设置
    public static func getTargetSettings() {
        let command = createCommand(with: [
            0x00,
    ...
    public static func getNewestHealthData(type: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func getStepData() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置目标设置
    public static func setTargetSettings(targetSwitch: Int, targetType: Int, targetLength: Int) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.targetSettings.rawValue,
            0x01,
    ...
    public static func setQRCode(type: UInt8, qrString: String) {
    ...
    // 获取多运动模式数据
    public static func getMultiSportModeData() {
        let command = createCommand(with: [
            0x00,
    ...
    // 删除运动模式数据
    public static func deleteSportModeData() {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.multiSportModeData.rawValue,
            0x01,
    ...
    // 获取睡眠数据
    public static func getHistorySleepData() {
        let command = createCommand(with: [
            0x00,
    ...
    public static func getSleepMonitoring() {
        let command = createCommand(with: [
            0x00,
    ...
    // 设置自动睡眠监测
    public static func setAutoSleepMonitoring(startHour: Int, startMinute: Int, endHour: Int, endMinute: Int, alarmCycle: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func dialMarketQuery(dataType: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func dialMarketSetTransferConfig(packageTotal: Int, binSize: Int, mtu: Int, dialType: Int, dialNum: Int, local: Int, typeValue: Int,  dialTypeValue: Int) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.dialMarket.rawValue,
            0x01,
    ...
    public static func dialMarketTransferData(packageNum: Int, binNum: Int, progressBar: Int, control: Int, data: Data) {
    ...
    public static func resourceUpgradeQuery() {
        let command = createCommand(with: [
            0x00,
    ...
    public static func resourceUpgradeSetTransferConfig(packageTotal: Int, binSize: Int, mtu: Int) {
        let command = createCommand(with: [
            0x00,
            XGZTCommands.resourceUpgrade.rawValue,
            0x01,
    ...
    public static func resourceUpgradeTransferData(data: Data) {
        var command = createCommand(with: [
            0x00,
            XGZTCommands.resourceUpgrade.rawValue,
            0x01,
    ...
    public static func startTest(cmdType: Int, control: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func setTimePositionAndColor(type: Int, position: Int, color: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func getNewestHeartData(type: Int) {
        let command = createCommand(with: [
            0x00,
    ...
    public static func handleResponse(response: [UInt8]) {
        ...
        case .getStepData:
            ...
            for i in stride(from: startIndex, to: response.count, by: stepDataLength) {
                ...
                let stepData = StepData(date: date, mac: fixedMac, step: step)
                healthDataStorage.saveStepData(stepData)
                XLogger.shared.log("历史步数读取成功: date=\(date), mac=\(fixedMac), step=\(step)")
            }
        ...
        case .getHistorySleepData:
            ...
            for i in stride(from: startIndex, to: response.count, by: stepDataLength) {
                ...
                let sleepData = SleepData(date: date, mac: fixedMac, awake: awake, light: light, deep: deep)
                healthDataStorage.saveSleepData(sleepData)
                XLogger.shared.log("历史睡眠读取成功: date=\(date), mac=\(fixedMac), awake=\(awake), light=\(light), deep=\(deep)")
        ...
        case .startTest:
            ...
            if response.count >= 11 {
                ...
                if cmdType == 0 {
                    ...
                    let heartData = HeartData(mac: lastestDeviceMac, time: time, heart: Int(response[10]))
                    healthDataStorage.saveHeartData(heartData)
                    NotificationCenter.default.post(name: Notification.Name("HealthViewController"), object: "heart")
                    ...
                    let oxygenData = OxygenData(mac: lastestDeviceMac, time: time, oxygen: Int(response[10]))
                    healthDataStorage.saveOxygenData(oxygenData)
                    NotificationCenter.default.post(name: Notification.Name("HealthViewController"), object: "oxygen")
                    ...
                    let bloodPressureData = BloodPressureData(mac: lastestDeviceMac, time: time, max: Int(response[10]), min: Int(response[11]))
                    healthDataStorage.saveBloodPressureData(bloodPressureData)
                    NotificationCenter.default.post(name: Notification.Name("HealthViewController"), object: "blood")
...
class QRCodeSetCommand {
    ...
    public static func buildCommand(type: UInt8, qrString: String) -> Data? {
        // 校验收款码类型
...
class MACAddressComparator {
    ...
    public static func isMatching(_ mac1: String, _ mac2: String) -> Bool {
        // 分割MAC地址为字节数组
